...
<html lang="en">
    <head>
        ...
        <!-- text fonts -->
        <link rel="stylesheet" href="<?php echo e(asset('assets/css/ace-fonts.css')); ?>">
        ...
        <![endif]-->
        <link rel="stylesheet" href="<?php echo e(asset('assets/css/ace.onpage-help.css')); ?>">
                        ...
                        <div class="login-container">
                            ...
                            <div class="position-relative">
                                    ...
                                    <div class="widget-body">
                                        <div class="widget-main">
											...
											<?php if(Session::has('mensaje_error')): ?>
									            <?php echo Session::get('mensaje_error'); ?>
												...
												<fieldset>
                                                    <label class="block clearfix">
                                                        <span class="block input-icon input-icon-right">
                                                        	<?php echo Form::text('username', '' , array('class'=>'form-control', 'placeholder'=>'Usuario')); ?>
                                ...
                                <?php else: ?>
                                    ...
                                    <br />
                                    <h3><link rel="image" href="<?php echo e(asset('assets/assets/chrome.png')); ?>"> Google Chrome</h3>
                                    ace.onpage-help.css
                                    <h3><link rel="image" href="<?php echo e(asset('assets/assets/firefox.png')); ?>"> Mozilla Firefox</h3>
                                    </div>
                                <?php endif; ?>
